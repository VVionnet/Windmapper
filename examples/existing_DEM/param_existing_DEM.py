...
#Parameter for atmospheric stability in Wind Ninja mass conserving
alpha = 1.0 # Should be set to one
...
# Averaging method to compute the transfert function in the downscaling method
...
# Output directory
#user_output_dir='/home/vvionnet/data3/Run_WindNinja/test_wn'
